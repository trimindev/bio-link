    ...
    0: function (t, e, i) {
      ...
      function u(t) {
        for (; t.children && t.children.length > 0; )
          u(t.children[0]), t.remove(t.children[0]);
    ...
    12: function (t, e, i) {
      ...
      class r extends s.b {
        ...
        onInit() {
          ...
          h.setAttribute(
            'position',
            new n.BufferAttribute(this.linePositions, 3).setUsage(
              n.DynamicDrawUsage
            )
          ),
            h.setAttribute(
              'color',
              new n.BufferAttribute(this.lineColors, 3).setUsage(
                n.DynamicDrawUsage
              )
            ),
          ...
          const l = new n.AmbientLight(16777215, 0.75);
          return (
            this.scene.add(l),
          ...
          super.setOptions(t),
            t.color &&
              this.points.forEach((e) => {
                e.material.color = new n.Color(t.color);
              });
        }
        onUpdate() {
          let t;
          ...
          for (let t = 0; t < this.points.length; t++) {
            ...
            l = this.rayCaster
              ? this.rayCaster.ray.distanceToPoint(c.position)
              : 1e3;
            const u = l.clamp(5, 15);
            if (
              ((c.scale.x =
                c.scale.y =
                c.scale.z =
              ...
              let t = Math.atan2(c.position.z, c.position.x);
              (e = Math.sqrt(
                c.position.z * c.position.z + c.position.x * c.position.x
              )),
                (t += 25e-5 * c.r),
                (c.position.x = e * Math.cos(t)),
                (c.position.z = e * Math.sin(t));
            }
            for (let l = t; l < this.points.length; l++) {
              const t = this.points[l],
